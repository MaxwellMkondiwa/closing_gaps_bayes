---
title: "ExperimentalDataAnalysis"
format: html
editor: visual
---
...
newdata=read.csv("G:/My Drive/2021 Malawi Bayes Fertilizer/Data/dta/ExperimentalData/Rawdata.csv",header=TRUE,sep=",")
attach(newdata)
summary(newdata)
head(newdata)
newdata=na.omit(newdata)
#newdata=within(newdata,relevel(newdata$y95_96,"1997/98"))
names(newdata)
...
print(ExperimentalModelmcmctable1, type = "html", file = "G:/My Drive/2021 Malawi Bayes Fertilizer/Data/Tables/ExperimentalModeltable1.doc")
...
```{r}
source("G:/My Drive/2021 Malawi Bayes Fertilizer/Data/Rcodes/mcmctab.R")
forcdfnoninformartiveprior_result=mcmctab(forcdfnoninformartiveprior)
write.csv(forcdfnoninformartiveprior_result,"G:/My Drive/2021 Malawi Bayes Fertilizer/Data/Tables/forcdfnoninformartiveprior_result.csv")
...
ggsave("stochasticdominancevarfromData.png", dpi=300)
...
print(ExperimentalHierModelmcmctable1, type = "html", file = "C:/Users/mkond/OneDrive/PhD Dissertation/Essay 1/Data and Models/ExperimentalHierModeltable1.doc")
